  ...
  'relative w-full rounded-lg border px-4 py-3 text-sm [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground [&>svg~*]:pl-7',
  {
    variants: {
      variant: {
        ...
        success:
          'border-emerald-500/40 text-emerald-700 dark:text-emerald-400 [&>svg]:text-emerald-600 bg-emerald-500/5',
        warning:
          'border-amber-500/40 text-amber-700 dark:text-amber-400 [&>svg]:text-amber-600 bg-amber-500/5',
      },
    },
    defaultVariants: {
      variant: 'default',
