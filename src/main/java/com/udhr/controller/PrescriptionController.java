...
public class PrescriptionController {
    ...
    public ResponseEntity<?> getReport(
        ...
        try {
            PrescriptionReportResponse report = prescriptionService.getReport(staffNumber, startDate, endDate);
    ...
    public ResponseEntity<?> exportReportCsv(
        ...
        try {
            String csv = prescriptionService.exportCsv(staffNumber, startDate, endDate);
            return ResponseEntity.ok()
                    .contentType(MediaType.parseMediaType("text/csv"))
                    .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"prescriptions.csv\"")
